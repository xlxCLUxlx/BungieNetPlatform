...
namespace BungieNetPlatform.BungieNetPlatform.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DestinyHistoricalStatsDestinyLeaderboardResults : Dictionary<String, Dictionary>,  IEquatable<DestinyHistoricalStatsDestinyLeaderboardResults>, IValidatableObject
    {
        /// <summary>

...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>, IValidatableObject
    {
        ...
        public InlineResponse20030(DestinyDefinitionsDestinyDefinition Response = default(DestinyDefinitionsDestinyDefinition), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

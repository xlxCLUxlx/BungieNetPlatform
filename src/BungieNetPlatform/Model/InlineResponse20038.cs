...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20038 :  IEquatable<InlineResponse20038>, IValidatableObject
    {
        ...
        public InlineResponse20038(DestinyDestinyEquipItemResults Response = default(DestinyDestinyEquipItemResults), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

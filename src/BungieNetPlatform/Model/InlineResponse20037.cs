...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20037 :  IEquatable<InlineResponse20037>, IValidatableObject
    {
        ...
        public InlineResponse20037(DestinyResponsesDestinyVendorResponse Response = default(DestinyResponsesDestinyVendorResponse), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

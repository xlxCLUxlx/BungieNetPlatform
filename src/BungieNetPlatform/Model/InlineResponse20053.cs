...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20053 :  IEquatable<InlineResponse20053>, IValidatableObject
    {
        ...
        public InlineResponse20053(TrendingTrendingCategories Response = default(TrendingTrendingCategories), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

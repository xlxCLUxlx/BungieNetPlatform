...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20055 :  IEquatable<InlineResponse20055>, IValidatableObject
    {
        ...
        public InlineResponse20055(TrendingTrendingDetail Response = default(TrendingTrendingDetail), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20036 :  IEquatable<InlineResponse20036>, IValidatableObject
    {
        ...
        public InlineResponse20036(List<DestinyResponsesDestinyVendorResponse> Response = default(List<DestinyResponsesDestinyVendorResponse>), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {
        ...
        public List<DestinyResponsesDestinyVendorResponse> Response { get; set; }

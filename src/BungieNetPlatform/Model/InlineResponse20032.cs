...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20032 :  IEquatable<InlineResponse20032>, IValidatableObject
    {
        ...
        public InlineResponse20032(DestinyResponsesDestinyProfileResponse Response = default(DestinyResponsesDestinyProfileResponse), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

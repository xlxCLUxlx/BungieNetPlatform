...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20021 :  IEquatable<InlineResponse20021>, IValidatableObject
    {
        ...
        public InlineResponse20021(SearchResultOfGroupMember Response = default(SearchResultOfGroupMember), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

...
namespace BungieNetPlatform.Model
{
    ...
    public partial class InlineResponse20052 :  IEquatable<InlineResponse20052>, IValidatableObject
    {
        ...
        public InlineResponse20052(CommunityCommunityLiveStatus Response = default(CommunityCommunityLiveStatus), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>))
        {

...
------------ | ------------- | ------------- | -------------
**RewardCategoryHash** | **uint?** | Look up the relevant DestinyMilestoneDefinition, and then use rewardCategoryHash to look up the category info in DestinyMilestoneDefinition.rewards. | [optional] 

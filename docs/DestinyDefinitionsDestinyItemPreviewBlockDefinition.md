...
------------ | ------------- | ------------- | -------------
**PreviewVendorHash** | **uint?** | If the preview data is derived from a fake \&quot;Preview\&quot; Vendor, this will be the hash identifier for the DestinyVendorDefinition of that fake vendor. | [optional] 
